...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=doEdit">
  <table width="60%" border="0" align="center" cellpadding="5" cellspacing="2">
    ...
    <tr>
      ...
      <td>County</td>
      <td>:</td>
      <td><input name="County" type="text" id="County"  value="<%=(String)all.get(4)%>"/></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="2"><label>
        <input name="Submit" type="submit" onclick="MM_validateForm('Username','','R','Password','','R','Address','','R','City','','R','County','','R','Mobile','','R','Email','','RisEmail');return document.MM_returnValue" value="User Edit" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
